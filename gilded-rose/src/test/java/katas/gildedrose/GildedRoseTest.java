...
public class GildedRoseTest {
	...
	public void testAddItem() {
		...
		app.updateQuality();
		Assert.assertEquals("foo", app.getItems().get(0).name);
	}
	...
	public void testAddItemDecrementDoubleQuality() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(3, app.getItems().get(0).quality);
	}
	...
	public void testAddMultipleItemsUpdateQuality() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(0, app.getItems().get(0).quality);
		Assert.assertEquals(1, app.getItems().get(1).quality);
	}
	...
	public void testUpdateQualityDecrementQuality() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(2, app.getItems().get(0).quality);
	}
	...
	public void testUpdateQualityInDecrementSellIn() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(2, app.getItems().get(0).sellIn);
	}
	...
	public void testUpdateQualityInDecrementDoubleQuality() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(1, app.getItems().get(0).quality);
	}
	...
	public void testAddAgedBrieUpdateQualityIncrementQuality() {
		...
		// triangule values
		app.updateQuality();
		Assert.assertEquals(4, app.getItems().get(0).quality);
		app.updateQuality();
		Assert.assertEquals(6, app.getItems().get(0).quality);
	}
	...
	public void testAddAgedBrieUpdateQualityGreaterFiftyIsNotAdded() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(0, app.getItems().get(0).sellIn);
		Assert.assertEquals(50, app.getItems().get(0).quality);
	}
	...
	public void testSulfurasUpdateQualityNotDecrement() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(1, app.getItems().get(0).sellIn);
		Assert.assertEquals(40, app.getItems().get(0).quality);
	...
	public void testBackstagePassesUpdateQuality() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(43, app.getItems().get(0).quality);
	}
	...
	public void testBackstagePassesUpdateQualityIncrementDoubleQuality() {
		...
		GildedRose app = new GildedRose(items);
		app.updateQuality();
		Assert.assertEquals(5, app.getItems().get(0).quality);
	}
